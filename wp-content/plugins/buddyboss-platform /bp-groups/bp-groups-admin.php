						...
						<div id="postdiv">
							<div id="bp_groups_name" class="postbox">
								...
								<div class="inside">
									...
									<!-- Postleitzahl -->
									<label for="bp-groups-plz" class="screen-reader-text">
									<?php
										/* translators: accessibility text */
										_e( 'Postleitzahl', 'buddyboss' );
									?>
										</label>
										<H4>Postleitzahl</H4>
									<input required type="text" name="bp-groups-plz" id="bp-groups-plz" value="" />


									<!-- Stadt -->
									<label for="bp-groups-stadt" class="screen-reader-text">
									<?php
										/* translators: accessibility text */
										_e( 'Group Stadt', 'buddyboss' );
									?>
										</label> 
										<H4>Stadt</H4>
									<input required type="text" name="bp-groups-stadt" id="bp-groups-stadt" value="" />

									<!-- StadtTeil -->
									<label for="bp-groups-stadtteil" class="screen-reader-text">
									<?php
										/* translators: accessibility text */
										_e( 'Group stadtteil', 'buddyboss' );
									?>
										</label>
										<H4>Stadtteil</H4>
									<input required type="text" name="bp-groups-stadtteil" id="bp-groups-stadtteil" value="" />
